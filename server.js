...
const CLIENT_ID = <REPLACE WITH YOUR APPLICATIONS CLIENT ID>; //Client ID generated from your application page
const CLIENT_SECRET = <REPLACE WITH YOUR APPLICATIONS CLIENT SECRET>;
...
var options = {
  ...
  passphrase: <REPLACE WITH YOUR APPLICATIONS CLIENT SECRET>
};
